...
final class Register extends Transformer
{
    ...
    {
        $this->addField(
            Entity\Register::FIRST_NAME,
            $register->getFirstName(),
            'string'
        );
        $this->addField(
            Entity\Register::LAST_NAME,
            $register->getLastName(),
            'string'
        );
        $this->addField(
            Entity\Register::COMPANY,
            $register->getCompany(),
            'string'
        );
        $this->addField(
        ...
        $this->addField(
            Entity\Register::SALUTATION_ID,
            $register->getSalutationId(),
            'int'
        );
        $this->addField(
            Entity\Register::PASSWORD,
